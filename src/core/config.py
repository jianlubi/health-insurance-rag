...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "eval_deepeval": {
        "questions_path": "data/eval/test_questions.json",
        "output_path": "data/eval/deepeval_results.jsonl",
        "top_k": 4,
        "max_questions": 60,
        ...
        "metric_async_mode": False,
        "faithfulness_truths_extraction_limit": 20,
        "deepeval_retry_max_attempts": 3,
        "deepeval_per_attempt_timeout_seconds": 60,
        "deepeval_per_task_timeout_seconds": 220,
        "timeout_fallback_enabled": True,
        "timeout_fallback_max_context_items": 2,
        "timeout_fallback_max_context_chars": 320,
        "timeout_fallback_max_answer_chars": 420,
        "compact_metric_answer": True,
        "compact_metric_answer_max_sentences": 2,
        "compact_metric_answer_max_chars": 360,
        "rewrite_metric_answer": True,
        "rewrite_metric_answer_model": "gpt-4o-mini",
        "rewrite_metric_answer_max_chars": 360,
        "heuristic_faithfulness_fallback": True,
        "use_rerank": True,
        "use_sentence_window": True,
        "sentence_window_size": 0,
        "use_context_compression": True,
        "compression_max_sentences": 2,
        "compression_drop_irrelevant": True,
